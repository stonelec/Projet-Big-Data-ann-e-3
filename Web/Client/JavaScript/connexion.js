...
$(document).ready(function (){
    ...
    $('.connexion').submit(function(event) {
        ...
        ajaxRequest('GET', 'PHP/connexion.php?action=recuperer_email',function(response)  {
        ...
        ajaxRequest('GET', 'PHP/connexion.php?action=recuperer_mot_de_passe',function(response)  {
